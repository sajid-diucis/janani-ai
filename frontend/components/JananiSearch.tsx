...
function JananiSearchInner() {
    ...
    const handleVoiceResult = useCallback((text: string) => {
        console.log('[JananiSearch] 🎤 Voice input received:', text);
        setQuery(text);
        ...
        <div className="max-w-3xl mx-auto p-6">
            ...
            <div className="relative mb-8">
                <input
                    ...
                    placeholder="লক্ষণ লিখুন বা 🎤 বলুন... (যেমন: 'মাথা ব্যথা', 'জ্বর')"
                    disabled={!isReady}
                    className="w-full px-6 py-4 pr-24 text-lg rounded-2xl border-2 border-pink-200 dark:border-pink-800 bg-white dark:bg-gray-800 text-gray-900 dark:text-white placeholder-gray-400 focus:border-pink-500 focus:outline-none focus:ring-4 focus:ring-pink-100 dark:focus:ring-pink-900 transition-all disabled:opacity-50 disabled:cursor-not-allowed"
                />
            ...
            {!hasSearched && isReady && (
                <div className="text-center py-12 text-gray-400 dark:text-gray-500">
                    <p className="text-lg">আপনার সমস্যা লিখুন বা 🎤 বলুন</p>
